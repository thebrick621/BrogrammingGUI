...
# Try to open save file, if there isn't one yet then print no file yet and pass
try:
...
def delsave_confirm():
    ...
    while loop:
        ...
        titletext = hugestitchText.render('ERASING',True,flashcolors2[(flashcount%2)])
        default_cmdline = mediumstitchText.render('ARE YOU SURE?  Y OR N',True,flashcolors2[(flashcount%2)])
        pygame.draw.rect(screen,black,inputbox)
        screen.blit(titletext, (inputbox.x + 15 , inputbox.y + 5))
